$(document).ready(function() {
  ...
  var modalText = {
    discover: {
      title: 'Tindog',
      tag: 'A Place To Find Similar Dog.',
      detail:
        'Meet new and interesting dogs nearby.',
      link: 'https://trmpsanjay.github.io/Web-Devlopment-Projects/Tindog/'
    },
    ordering: {
      title: 'Github',
      tag: 'GitHub Profile.',
      detail:
        'Please Vsist My Github Profile.',
      link: 'https://github.com/trmpsanjay'
    },
    newrelic: {
      title: 'Tindog',
      tag: 'A Place To Find Similar Dog.',
